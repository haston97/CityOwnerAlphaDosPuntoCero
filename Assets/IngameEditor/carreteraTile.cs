...
public class carreteraTile : Tile
{
    static public Texture2D texture;
    public Sprite[] tSprites;
    int tilesArriba = 0, tilesAbajo = 0;
    ...
    public override void GetTileData(Vector3Int location, ITilemap tilemap, ref TileData tileData)
    {
        ...
        if (tilesAbajo-1 == tilesArriba)
        {
            tileData.sprite = tSprites[48];
        }
        if (tilesAbajo+1 == tilesArriba)
        {
            tileData.sprite = tSprites[49];
        }
    }
    ...
    private void CTTIAD(ITilemap tilemap, Vector3Int position, Vector3Int increment)
    {
        ...
        Debug.Log(tilesArriba.ToString()+tilesAbajo.ToString());
